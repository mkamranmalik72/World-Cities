...
class CreateWorldCitiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('world_cities', function (Blueprint $table) {
            ...
            $table->string('name', 255)->default('')->comment('CityClass Name');
            $table->string('full_name', 255)->nullable()->comment('CityClass Fullname');
            $table->string('code', 64)->nullable()->comment('CityClass Code');
